...
int main()
{
    GLFWwindow *window = createWindow("Lista 2 - Exercicio 2", 800, 600, false);
    if (!window) return -1;
    ...
    // As coordenadas correspondem diretamente a posições na janela 800 x 600.
    ...
    // A inversão dos limites de Y coloca a origem no canto superior esquerdo.
    ...
    glUniform4f(colorLocation, 0.12f, 0.76f, 0.82f, 1.0f);
